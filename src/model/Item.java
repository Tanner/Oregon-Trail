...
public abstract class Item implements Conditioned, Comparable<Item>{
	...
	public enum ITEM_TYPE {
		...
		private ITEM_TYPE (String name, String description, String cost, String weight) {
			this.name = name;
			this.description = description;
