...
export class HuntHUD extends HUD {
    constructor(width, onCamp, onInventory) {
        ...
        this.add(this.ammoLabel, { x: HuntHUD.MARGIN, y: HUD.HEIGHT / 2 }, ReferencePoint.CENTERLEFT, 0, 0);
        ...
        this.add(this.campButton, { x: width - HuntHUD.MARGIN - 100, y: HUD.HEIGHT / 2 }, ReferencePoint.CENTERRIGHT, 0, 0);
        this.add(this.inventoryButton, { x: this.campButton.getX() - HuntHUD.MARGIN, y: HUD.HEIGHT / 2 }, ReferencePoint.CENTERRIGHT, 0, 0);
    }
