...
export class SplashScene extends Scene {
    ...
    init(canvasWidth, canvasHeight) {
        ...
        this.whitePanelAnimatingColor = new AnimatingColor(Color.black, Color.white, SplashScene.WAIT_TIME / 4 - SplashScene.DELAY);
        ...
        this.blackPanelAnimatingColor = new AnimatingColor(Color.black, Color.white, SplashScene.WAIT_TIME / 4 - SplashScene.DELAY);
        ...
        this.whitePanel.add(this.nullLogo, this.whitePanel.getPosition(ReferencePoint.CENTERRIGHT), ReferencePoint.CENTERRIGHT, -10, 0);
        ...
        this.blackPanel.add(this.voidLogo, this.blackPanel.getPosition(ReferencePoint.CENTERLEFT), ReferencePoint.CENTERLEFT, 10, 0);
    ...
    update(delta) {
        ...
        if (this.time >= SplashScene.WAIT_TIME) {
            ...
            this.blackPanelAnimatingColor = new AnimatingColor(Color.white, Color.black, SplashScene.WAIT_TIME / 4 - SplashScene.DELAY);
            this.blackPanel.setBackgroundColor(this.blackPanelAnimatingColor);
        }
...
SplashScene.WAIT_TIME = 3000;
SplashScene.DELAY = 100;
