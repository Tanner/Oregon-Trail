...
export class TrailScene extends Scene {
    constructor(canvasWidth, canvasHeight, party) {
        ...
        this.skyColor = new AnimatingColor(new Color(135, 206, 235), new Color(25, 25, 112), 10000);
    ...
    initialize(canvasWidth, canvasHeight) {
        ...
        if (this.party.getVehicle()) {
            ...
            this.wagon.setPosition({ x: canvasWidth / 2, y: canvasHeight - 150 }, ReferencePoint.BOTTOMCENTER);
        }
        this.hudLayer.add(this.hud);
        this.hud.setPosition({ x: 0, y: 0 }, ReferencePoint.TOPLEFT);
    }
    setupParallax(canvasWidth, canvasHeight) {
        ...
        ground.setPosition({ x: 0, y: canvasHeight - ground.getHeight() }, ReferencePoint.TOPLEFT);
        ...
        trail.setPosition({ x: 0, y: canvasHeight - trail.getHeight() - 20 }, ReferencePoint.TOPLEFT);
        ...
        hillA.setPosition({ x: 0, y: canvasHeight - ground.getHeight() - hillA.getHeight() + 50 }, ReferencePoint.TOPLEFT);
        ...
        hillB.setPosition({ x: canvasWidth / 4, y: canvasHeight - ground.getHeight() - hillB.getHeight() + 30 }, ReferencePoint.TOPLEFT);
...
TrailScene.WALK_TICK_INTERVAL = 1000;
TrailScene.STEP_COUNT_TRIGGER = 2;
//# sourceMappingURL=TrailScene.js.map