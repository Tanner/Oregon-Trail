...
export var StateIdx;
(function (StateIdx) {
    StateIdx["MISSOURI"] = "MISSOURI";
    StateIdx["KANSAS_TERRITORY"] = "KANSAS_TERRITORY";
    StateIdx["NEBRASKA_TERRITORY"] = "NEBRASKA_TERRITORY";
    StateIdx["COLORADO_TERRITORY"] = "COLORADO_TERRITORY";
    StateIdx["DAKOTA_TERRITORY"] = "DAKOTA_TERRITORY";
    StateIdx["WASHINGTON_TERRITORY"] = "WASHINGTON_TERRITORY";
    StateIdx["UTAH_TERRITORY"] = "UTAH_TERRITORY";
    StateIdx["OREGON"] = "OREGON";
})(StateIdx || (StateIdx = {}));
export var BackgroundType;
(function (BackgroundType) {
    BackgroundType["GRASS"] = "GRASS";
    BackgroundType["SNOW"] = "SNOW";
    BackgroundType["MOUNTAIN"] = "MOUNTAIN";
    BackgroundType["DESERT"] = "DESERT";
})(BackgroundType || (BackgroundType = {}));
export var Environments;
(function (Environments) {
    Environments["FOREST"] = "FOREST";
    Environments["SNOWY_FOREST"] = "SNOWY_FOREST";
    Environments["HILLS"] = "HILLS";
    Environments["SNOWY_HILLS"] = "SNOWY_HILLS";
    Environments["MOUNTAINS"] = "MOUNTAINS";
    Environments["SNOWY_MOUNTAINS"] = "SNOWY_MOUNTAINS";
    Environments["PLAINS"] = "PLAINS";
    Environments["SNOWY_PLAINS"] = "SNOWY_PLAINS";
...
const buildLiterals = () => {
    ...
    const sceneSelectorScene = new Map();
    ...
    const partyCreationScene = new Map();
    ...
    const partyInventoryScene = new Map();
...
export function get(outer, inner) {
    return LITERALS.get(outer)?.get(inner) ?? "";
}
//# sourceMappingURL=ConstantStore.js.map