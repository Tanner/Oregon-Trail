...
export class ComponentModal<T extends Component> extends Modal {
  private component: T;
  ...
  constructor(
    ...
    const panelWidth =
      Modal.PADDING * 2 + Math.max(component.getWidth(), this.messageLabel.getWidth());
    const panelHeight =
      Modal.PADDING * 4 +
    ...
    this.panel.add(
      component,
      this.messageLabel.getPosition(ReferencePoint.BOTTOMCENTER),
      ReferencePoint.TOPCENTER,
      0,
      Modal.PADDING
    );
